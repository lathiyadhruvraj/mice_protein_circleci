...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        ...
        try:
            ...
            plt.plot(range(1, 31), wcss)  # creating the graph between W CSS and the number of clusters
            ...
            self.kn = KneeLocator(range(1, 31), wcss, curve='convex', direction='decreasing')
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in elbow_plot method of the KMeansClustering class. Exception '
                                   'message:  ' + str(e))
            self.logger_object.log(self.file_object,
                                   'Finding the number of clusters failed. Exited the elbow_plot method of the '
    ...
    def create_clusters(self, data, number_of_clusters):
        ...
        try:
            ...
            # data = data[~data.is in([np.nan, np.inf, -np.inf]).any(1)]
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in create_clusters method of the KMeansClustering class. '
                                   'Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,
                                   'Fitting the data to clusters failed. Exited the create_clusters method of the '
                                   'KMeansClustering class') 
            raise Exception()
